...
def customerInfo():
    ...
    # Province List
    provLst = ["NL", "NS", "NB", "PE", "PQ", "ON", "MB", "AB", "BC", "NT", "YT", "SK", "NV"]
    while True:
        # Customer province
...
def vehicleInfo():
    ...
    if extraLiab == "Y":
        print("Customer has decided for Extra Liability Coverage!")
    else:
        print("Customer has decided not to have Extra Liability Coverage.")
    ...
    if glassCoverage == "Y":
        print("Customer has decided for Optional Glass Coverage!")
    else:
        print("Customer has decided not to have Optional Glass Coverage.")
    ...
    if loanerCar == "Y":
        print("Customer has decided for a Loaner Car!")
    else:
        print("Customer has decided not to have a Loaner Car.")
...
def paymentInfo():
    ...
    while True:
        ...
        if paymentMethod not in paymentMethodLst:
            ...
            while True:
                downPaymentStr = input("How much would the customer like to pay as a down payment? ")
                try:
